...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:Panel ID="ControlPanel" runat="server">
            ...
            <br /><br />
            <asp:GridView ID="TrackListGV" runat="server" AutoGenerateColumns="False" 
                DataSourceID="TracksDataODS" GridLines="Horizontal" BorderStyle="None" CssClass="table" 
                OnSelectedIndexChanged="TrackListGV_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ItemStyle-Width="400px"></asp:BoundField>
                    <asp:TemplateField HeaderText="Milliseconds">
                      <ItemTemplate>
                          <%# Eval("Milliseconds") %>
                      </ItemTemplate>
                    </asp:TemplateField> 
